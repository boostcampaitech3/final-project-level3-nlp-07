...
class KoGPTSummaryModule(pl.LightningDataModule):
    def __init__(self, train_file,
        ...
        if tok is None:
            ...
            self.tok.add_special_tokens(special_tokens_dict)
        else:
            self.tok = tok
...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(name='[lkm] KoGPT2 b32 m256_add_special',project='[lkm] KoGPT2 pl')
